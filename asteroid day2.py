...
d1 = Path('26Proserpina/26Proserpina/20120120/Day 2')
day1 = os.listdir(d1)
...
plt.savefig("d2_1.pdf",bbox_inches = 'tight')
plt.show()
...
d1_dark = Path('26Proserpina/26Proserpina/20120120/Dark day 2')
...
d1_bias = Path('26Proserpina/26Proserpina/20120120/Bias day 2')
...
d1_flat = Path('26Proserpina/26Proserpina/20120120/Flats day 2')
...
plt.savefig("d2_2.pdf",bbox_inches = 'tight')
plt.show()
...
if __name__ == '__main__':
    ...
    plt.tight_layout()
    plt.legend()
    plt.savefig("d2_3.pdf",bbox_inches = 'tight')
    plt.show()
...
plt.savefig("d2_4.pdf",bbox_inches = 'tight')
plt.show()
...
plt.legend()
plt.savefig("d2_5.pdf",bbox_inches = 'tight')
plt.show()
...
plt.savefig("d2_6.pdf",bbox_inches = 'tight')
plt.show()
...
plt.legend(loc='best')
plt.savefig("d2_7.pdf",bbox_inches = 'tight')
plt.show()
...
plt.legend()
#plt.axis((0,2045,-5,5))
plt.savefig("d2_8",bbox_inches = 'tight')
plt.show()
...
plt.legend()
plt.savefig("d2_9.pdf",bbox_inches = 'tight')
plt.show()
#finding the big X and big Y using T1

#location from pictures
smallxy =  [1035.3,1044.19,1]
...
plt.legend()
plt.savefig("d2_10.pdf",bbox_inches = 'tight')
plt.show()
