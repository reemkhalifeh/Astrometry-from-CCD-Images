...
d1 = Path('26Proserpina/26Proserpina/20120122/Day 3')
day1 = os.listdir(d1)
...
plt.savefig("d3_1.pdf",bbox_inches = 'tight')
plt.show()
...
d1_dark = Path('26Proserpina/26Proserpina/20120122/Dark day 3')
...
d1_bias = Path('26Proserpina/26Proserpina/20120122/Bias day 3')
...
d1_flat = Path('26Proserpina/26Proserpina/20120122/Flats day 3')
...
plt.savefig("d3_2.pdf",bbox_inches = 'tight')
plt.show()
#find the USNO stars
...
if __name__ == '__main__':
    ...
    plt.ylabel("DEC [deg]")
    plt.tight_layout()
    plt.savefig("d3_3.pdf",bbox_inches = 'tight')
    plt.show()
...
plt.savefig("d3_4.pdf",bbox_inches = 'tight')
plt.show()
...
plt.legend()
plt.savefig("d3_5.pdf",bbox_inches = 'tight')
plt.show()
...
plt.legend(loc='best')
plt.savefig("d3_6.pdf",bbox_inches = 'tight')
plt.show()
...
plt.legend(loc='best')
plt.savefig("d3_7.pdf",bbox_inches = 'tight')
plt.show()
...
plt.legend()
#plt.axis((0,2045,-5,5))
plt.savefig("d3_8",bbox_inches = 'tight')
plt.show()
...
plt.legend()
plt.savefig("d3_9.pdf",bbox_inches = 'tight')
plt.show()
#finding the big X and big Y using T1

#location from pictures
smallxy =  [1032.24,1018.44,1]
...
plt.legend()
plt.savefig("d3_10.pdf",bbox_inches = 'tight')
plt.show()
