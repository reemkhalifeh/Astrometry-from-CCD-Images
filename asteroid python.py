...
d1 = Path('26Proserpina/26Proserpina/20120119/Day 1')
day1 = os.listdir(d1)
...
d1_bias = Path('26Proserpina/26Proserpina/20120119/Bias day 1')
...
d1_flat = Path('26Proserpina/26Proserpina/20120119/Flats day 1')
...
plt.savefig("d1_2.pdf",bbox_inches = 'tight')
plt.show()
...
if __name__ == '__main__':
    ...
    plt.ylabel("DEC [deg]")
    plt.tight_layout()
    plt.savefig("d1_3.pdf",bbox_inches = 'tight')
    plt.show()
...
plt.savefig("d1_4.pdf",bbox_inches = 'tight')
plt.show()
...
plt.legend()
plt.savefig("d1_5.pdf",bbox_inches = 'tight')
plt.show()
...
plt.legend(loc='best')
plt.legend()
plt.savefig("d1_6.pdf",bbox_inches = 'tight')
plt.show()
...
plt.legend(loc='best')
plt.savefig("d1_7",bbox_inches = 'tight')
plt.show()
...
plt.legend()
#plt.axis((0,2045,-5,5))
plt.savefig("d1_8",bbox_inches = 'tight')
plt.show()
...
plt.legend()
plt.savefig("d1_9.pdf",bbox_inches = 'tight')
plt.show()
#finding the big X and big Y using T1

#location from pictures
smallxy =  [1041.68,1006.25,1]
...
plt.legend()
plt.savefig("d1_10.pdf",bbox_inches = 'tight')
plt.show()
...
#arrayRMS = np.array([RMSxT2,RMSyT2,1])
#ERROR = np.dot(T3_inv,arrayRMS)
#RMS_alpha = (np.arctan(-((3454*(ERROR[0]/p)+1024)/((np.cos(deltanot))-((3454*(ERROR[1]/p)+1024)*np.sin(deltanot))))))+alphanot
#RMS_delta =(np.arcsin((np.sin(deltanot)+(((3454*(ERROR[1]/p)+1024))*np.cos(deltanot)))/(np.sqrt((1)+(((3454*(ERROR[1]/p)+1024))**2)+(((3454*(ERROR[0]/p)+1024))**2)))))
#RMS_error = (np.sqrt((RMS_delta**2)+(RMS_alpha**2)))*206265
#error = (np.sqrt((RMSxT2**2)+(RMSyT2**2)))
